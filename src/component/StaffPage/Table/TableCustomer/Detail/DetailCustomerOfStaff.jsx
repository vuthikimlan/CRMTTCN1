...
function DetailCustomerOfStaff(data) {
  ...
  return(
    <>
        <Descriptions layout="vertical"  >     
          ...
          <Descriptions.Item label="Người quản lý nhóm" span={3}> {dataCustomer?.group?.user?.name} </Descriptions.Item>
          <Descriptions.Item label="Ghi Chú" span={3}> {dataCustomer?.note} </Descriptions.Item>
        </Descriptions>
    </>
  );
} 
export default DetailCustomerOfStaff;